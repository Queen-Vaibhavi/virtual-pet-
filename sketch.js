...
var foodS,foodStock;
var fedTime,lastFed;
var feed,addFood,mejim;
var foodObj;

function preload(){
sadDog=loadImage("jimmy_image_1-removebg-preview.png");
happyDog=loadImage("jimmy_image_2-removebg-preview.png");

mejim = loadImage("Screenshot 2021-08-19 160715.png");
}
...
function setup() {
  ...
  dog=createSprite(825,230,150,150);
  dog.addImage(sadDog);
  dog.scale=0.4;
